function [result, glbestP, bestvaluerec, bestposrec] = mPSO(Xini, Vini, w, c1, c2, U1, U2, sig, obj, iters, up, lb)
    % Runs the modified Particle Swarm Optimisation algorithm.
    %
    % Inputs:
