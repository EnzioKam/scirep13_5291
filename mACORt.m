function [result, glbestP, bestvaluerec, bestposrec] = mACORt(Xini, q, zeta, sampleSize, sig, obj, iters, up, lb)
    % Runs the modified ACOR (Ant Colony Optimisation for continuous domains) algorithm.
    %
    % Inputs:
